...
docker run --rm --network=none --read-only --tmpfs /tmp:rw,noexec,nosuid,size=16m --tmpfs /run:rw,exec,nosuid,nodev,size=16m,mode=755 "$final_tag" hermes --help >/dev/null
