...
# Compose validates required selectors for all declared services even though
# this isolated project starts only Moss. Bind non-started personas to the
# same immutable local image ID without creating them.
export JEN_IMAGE_REF="$MOSS_SMOKE_IMAGE_ID"
export DENHOLM_IMAGE_REF="$MOSS_SMOKE_IMAGE_ID"
export ROY_IMAGE_REF="$MOSS_SMOKE_IMAGE_ID"
export RICHMOND_IMAGE_REF="$MOSS_SMOKE_IMAGE_ID"
export THE_ELDERS_IMAGE_REF="$MOSS_SMOKE_IMAGE_ID"
