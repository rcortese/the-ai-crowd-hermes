...
class Contract(unittest.TestCase):
 ...
 def test_executor_smoke_contract_is_confined_and_lock_bound(self):
  ...
  self.assertEqual(tmpfs,["/tmp:rw,noexec,nosuid,size=16m","/run:rw,exec,nosuid,nodev,size=16m,mode=755"])
 ...
 def test_executor_network_phase_policy_has_causal_mutation_oracles(self):
  ...
  def assert_smoke_policy(text):
   ...
   self.assertEqual(option_values(argv,"--tmpfs"),["/tmp:rw,noexec,nosuid,size=16m","/run:rw,exec,nosuid,nodev,size=16m,mode=755"])
  ...
  for mutant, oracle in (
   ...
   (script.replace("--tmpfs /tmp:rw,noexec,nosuid,size=16m","--tmpfs /tmp:rw,noexec,nosuid,size=16m --tmpfs /run:rw,exec,nosuid,nodev,size=16m,mode=755 --tmpfs /var/tmp:rw,noexec,nosuid,size=16m"),assert_smoke_policy),
   (script.replace(" --tmpfs /run:rw,exec,nosuid,nodev,size=16m,mode=755",""),assert_smoke_policy),
   (script.replace("/run:rw,exec,nosuid,nodev,size=16m,mode=755","/run:rw,nosuid,nodev,size=16m"),assert_smoke_policy),
   (script.replace("/run:rw,exec,nosuid,nodev,size=16m,mode=755","/run:rw,noexec,nosuid,nodev,size=16m"),assert_smoke_policy),
   (script.replace("/run:rw,exec,nosuid,nodev,size=16m,mode=755","/run:rw,exec,nosuid,size=16m"),assert_smoke_policy),
   (script.replace("/run:rw,exec,nosuid,nodev,size=16m,mode=755","/run:rw,exec,nosuid,nodev,size=16m"),assert_smoke_policy),
   (script.replace("/run:rw,exec,nosuid,nodev,size=16m,mode=755","/run:rw,exec,nosuid,nodev,size=32m,mode=755"),assert_smoke_policy),
