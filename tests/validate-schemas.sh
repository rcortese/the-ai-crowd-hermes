...
required_files = [
    ...
    'agents/public/moss/tools/wrappers/preflight-template.sh',
    'agents/public/moss/tools/wrappers/workspace-dirty-watch.sh',
    'agents/public/moss/tools/wrappers/README.md',
